...
import { useReports, useCreateReport, useDeleteReport } from "@/lib/hooks/useQuery";
import { FileText, Plus, X, Trash2, Search } from "lucide-react";
      ...
      <div className="space-y-3">
        ...
        {(data?.items ?? []).map((report) => {
          ...
          return (
            <div
              key={report.id}
              className="cyber-card p-4 cursor-pointer hover:border-cyan-500/30 hover:bg-white/[0.02] transition-all duration-150"
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <button
                  ...
                  className="p-1.5 rounded hover:bg-red-500/10 text-slate-600 hover:text-red-400 transition-colors cursor-pointer shrink-0"
